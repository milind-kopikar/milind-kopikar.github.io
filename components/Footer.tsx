      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <nav className="flex flex-wrap justify-center gap-6 text-sm text-gray-600" aria-label="Footer">
            <a href="#" className="hover:text-primary-600 transition-colors">Social</a>
            <Link href="/contact/" className="hover:text-primary-600 transition-colors">Contact Us</Link>
            <a href="#" className="hover:text-primary-600 transition-colors">Privacy</a>
            <a href="#" className="hover:text-primary-600 transition-colors">Footer</a>
          </nav>
        </div>
